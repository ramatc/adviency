...
const GiftContextProvider = ({ children }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const isInArray = gifts.map(gift => {return gift.receiver === data.receiver && gift.name === data.name})
        const index = isInArray.indexOf(true);
        const bool = isInArray.some(bool => bool === true);
       
        !bool ? (
            setGifts([...gifts, {id: giftId, name: data.name, price: data.price, img: data.url, receiver: data.receiver, qty: parseInt(data.number)}]),
            handleClear()
        ) : (
    ...
    const handleSubmitEdit = (e) => {
        ...
        setGifts([...gifts, {id: GIFT_ID, name: data.name, price: data.price, img: data.url, receiver: data.receiver, qty: parseInt(data.number)}]);
    }
